  ...
  $("#texas").hide();
   ...
   //parse of the json from nytimes
     ...
     for (var i = 0, len = tempPath.length; i < len; ++i) {
       ...
       byline.push(tempPath[i]["snippet"]);

      html += '<div class="article"><a href="https://www.nytimes.com/" (\''  + tempPath[i]["uri"] + '\')">' + tempPath[i]["headline"]["main"] + '</a></div>'
      \xa0 - 
      html += '<div class="description"><a href="https://www.nytimes.com/" (\')' + tempPath[i]["uri"] + '\')">' + tempPath[i]["snippet"] + '</a></div>'
     }
